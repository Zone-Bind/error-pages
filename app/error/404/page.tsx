...
export default async function Error404(props: {
  searchParams: Promise<{ location?: string }>
}) {
  const searchParams = await props.searchParams
  const location = searchParams.location || "Amsterdam"

  return <Error404Content location={location} />
}

function Error404Content({ location }: { location: string }) {
    ...
    <>
      ...
      <div className="main-content">
        <div className="header">
          ...
          <p>
            Visit{" "}
            <a href="https://zone-bind.com/error/404" target="_blank" rel="noopener noreferrer">
              zone-bind.com
            </a>{" "}
