...
import { AppWindow, Server, ShieldBan, Check, X } from "lucide-react"

export default async function Error403(props: {
  searchParams: Promise<{ location?: string }>
}) {
  const searchParams = await props.searchParams
  const location = searchParams.location || "Amsterdam"

  return <Error403Content location={location} />
}

function Error403Content({ location }: { location: string }) {
    ...
    <>
      ...
      <div className="main-content">
        <div className="header">
          ...
          <span className="error-code">Error code 403</span>
          <p>
            Visit{" "}
            <a href="https://zone-bind.com/error/403" target="_blank" rel="noopener noreferrer">
              zone-bind.com
            </a>{" "}
        ...
        <div className="content">
          ...
          <div>
            <h2>What can I do?</h2>
            <p>Contact the website owner if you believe you should have access.</p>
          </div>
        </div>
      </div>
