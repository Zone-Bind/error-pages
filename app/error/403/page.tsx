    ...
    <>
      <div className="main-content">
        <div className="header">
          ...
          <p>
            Visit <a href="https://zone-bind.com/error/403" target="_blank" rel="noopener noreferrer">zone-bind.com</a> for more information.
          </p>
        ...
        <div className="diagram-section">
          <div className="diagram">
            ...
            <div className="node">
              <div className="icon-wrapper">
                <div className="icon-container"><ShieldBan /></div>
