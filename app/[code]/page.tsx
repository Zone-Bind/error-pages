...
const errorConfigs: Record<string, ErrorConfig> = {
  "401": {
    ...
    icon: Lock,
    whatHappened: "The server requires authentication to access this resource.",
    whatCanIDo: "Provide valid credentials or contact the website administrator.",
  },
  "403": {
    title: "Access forbidden",
    description: "Access to",
    icon: ShieldBan,
    whatHappened: "Access to this resource on the server is denied.",
    whatCanIDo: "Contact the website owner if you believe you should have access.",
  },
  "404": {
    title: "Page not found",
    description: "The page you are looking for on",
    icon: FileQuestion,
    whatHappened: "The requested page could not be found on this server.",
    whatCanIDo: "Check the URL for typos or return to the homepage.",
  },
  "500": {
    title: "Internal server error",
    description: "The server for",
    icon: ServerOff,
    whatHappened: "The web server reported an internal error.",
  ...
  "502": {
    ...
    description: "The server for",
    icon: ServerOff,
    whatHappened: "The web server reported a bad gateway error.",
    whatCanIDo: "Please try again in a few minutes.",
  },
  "503": {
    title: "Service unavailable",
    description: "Service temporarily unavailable for",
    icon: AlertTriangle,
    whatHappened:
      "The origin server is temporarily unable to handle the request. This may be due to maintenance, overload, or a temporary issue.",
    whatCanIDo:
      "Try again in a few moments. If the problem persists, contact the website administrator or check back later.",
  },
}

export default async function ErrorPage({ params }: { params: Promise<{ code: string }> }) {
  const resolvedParams = await params
  return <ErrorPageClient code={resolvedParams.code} />
}

function ErrorPageClient({ code }: { code: string }) {
    ...
    <>
      <style jsx global>{`
        * {
        ...
        body {
          ...
          background: linear-gradient(135deg, #0a0a0a 0%, #0f0c18 50%, #0a0a0a 100%);
        ...
        .diagram-section {
          background: rgba(15, 12, 24, 0.4);
          border-top: 1px solid rgba(80, 80, 255, 0.15);
          border-bottom: 1px solid rgba(80, 80, 255, 0.15);
          padding: 3rem 2rem;
          margin-top: 2rem;
        }
        .diagram {
        ...
        .status-badge {
          ...
          height: 40px;
          border-radius: 50%;
          border: 3px solid rgba(15, 12, 24, 0.4);
          display: flex;
          align-items: center;
          justify-content: center;
          font-weight: bold;
        ...
        .footer {
          ...
          font-size: 0.8125rem;
          border-top: 1px solid rgba(80, 80, 255, 0.1);
          width: 100%;
        }
        .footer-content {
          max-width: 1200px;
      ...
      <div className="main-content">
        <div className="header">
          ...
          <p>
            Visit{" "}
            <a href={`https://zone-bind.com/error/${code}`} target="_blank" rel="noopener noreferrer">
              zone-bind.com
            </a>{" "}
